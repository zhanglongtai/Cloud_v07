...
export default React.createClass({
    ...
    threeSTLModel: function() {
		...
		function init() {
            ...
            _this.state[exactModelName] = false;
        ...
        function onDocumentMouseDown( event ) {
            ...
            if ( intersects.length > 0 ) {
                ...
                if (_this.state[objectsInScene[0].geometry.name]) {
                    objects[0].material.setValues( {color: 0x7777ff} );
                    let tmp_state = _this.state;
    ...
    resetX: function() {
        var center = objects[0].geometry.center();
        var boundbox = objects[0].geometry.boundingBox;
